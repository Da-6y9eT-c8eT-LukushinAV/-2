namespace Composite_Pattern
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Paragraph para5 = new Paragraph("Параграф !.");
            ...
            // Ошибка: нельзя добавить параграф в документ
            try
            {
                document.Add(para5);
            }
            ...
            {
                Console.WriteLine(ex.Message); // В документ можно добавлять только разделы.
            }
